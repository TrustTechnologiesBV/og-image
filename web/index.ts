...
const App = (_: any, state: AppState, setState: SetState) => {
  ...
  const {
    ...
    theme = "light",
    md = true,
    text = "Find **reliable** recruiting agencies,<br />based on **honest reviews.**",
  ...
  url.pathname = `/i/${encodeURIComponent(text)}.${fileType}`;
